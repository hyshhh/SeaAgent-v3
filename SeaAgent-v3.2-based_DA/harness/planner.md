...
- Read the returned table as the only source of facts. If a subagent reports "存疑", carry that uncertainty into the answer instead of resolving it yourself.
- You may read skill files in /skills when you need the rules for scoping a task.
